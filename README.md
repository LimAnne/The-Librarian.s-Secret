...
*This repo is an exploratory study, so the studies, techniques discussed here are not immediately the best and final ways to go about things..methods will be refined and more polished as time passes - as I am an advocate for continous improvement* :smile:
